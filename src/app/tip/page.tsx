      ...
      <section className="relative isolate overflow-hidden border-b border-white/5 pb-20 pt-40">
        ...
        <Container className="relative">
          ...
          <h1 className="display-stencil text-hero text-ink-50">
            Tell us
            <br />
            <span className="text-signal-500">what you know.</span>
          </h1>
      ...
      <section className="py-20">
        <Container size="lg">
          <div className="grid gap-16 lg:grid-cols-[1.3fr_1fr]">
            <div>
              <div className="rounded-md border border-white/10 bg-ink-900/40 p-8 sm:p-10 backdrop-blur">
                <TipForm />
              </div>
            </div>
            ...
            <aside aria-label="Our security posture">
              ...
              <ul className="space-y-6">
                {POSTURE.map((p) => (
                  <li
                    key={p.h}
                    className="rounded-md border border-white/10 bg-ink-900/30 p-5"
                  >
                    <div className="mb-3 inline-flex h-9 w-9 items-center justify-center rounded-full border border-white/10 text-signal-400">
                      <p.Icon size={14} />
                    </div>
                    <h3 className="font-display text-xl font-bold tracking-tight text-ink-50">
                      {p.h}
                    </h3>
                    <p className="mt-2 text-sm text-ink-300">{p.p}</p>
                  </li>
                ))}
              </ul>
              ...
              <div className="mt-8 rounded-md border border-dashed border-white/15 p-5">
                ...
                <p className="text-sm text-ink-300">
                  Submit via Tor at our <code className="rounded bg-black/40 px-1.5 py-0.5 font-mono text-[11px] text-signal-300">.onion</code> mirror
